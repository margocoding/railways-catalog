        ...
        <div className="relative min-h-[90vh] flex items-center overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <span className="text-lg opacity-70 group-hover:opacity-100 transition-opacity">
                      {getCategoryIcon(category.id)}
                                        ...
                                        <span
                                            className="text-white group-hover:text-[hsl(var(--primary))] transition-colors">
                      {category.name}
                    </span>
                                    </div>
                                </motion.a>
                  ...
                  России и СНГ
                            ...
                            <div className="flex gap-8 pt-6 border-t border-[hsl(var(--border))]">
                                {[
                                    ...
                                    <div key={stat.label}>
                                        <div
                                            className="text-2xl md:text-3xl font-black bg-accent-gradient bg-clip-text text-white">
                                            {stat.value}
                                        </div>
            ...
            {mobileCategoriesOpen && (
                <div className="fixed inset-0 z-50 lg:hidden">
                    ...
                    {/* Drawer */}
                    <div
                        className="absolute left-0 top-0 bottom-0 w-72 bg-[hsl(var(--card))] shadow-2xl overflow-y-auto">
