...
export const products: Product[] = [
  // Рельсы новые
  {
    ...
    stock: 150,
    condition: 'new',
    images: ['/placeholders/rail-r65.svg'],
  ...
  },
  {
    ...
    stock: 200,
    condition: 'new',
    images: ['/placeholders/rail-r50.svg'],
    categoryId: 'rails-new',
    sectionId: 'rails',
  ...
  },
  {
    ...
    stock: 80,
    condition: 'new',
    images: ['/placeholders/rail-r65-25.svg'],
    categoryId: 'rails-new',
    sectionId: 'rails',
  ...
  // Рельсы б/у
  {
    ...
    stock: 300,
    condition: 'used',
    images: ['/placeholders/rail-r65-used.svg'],
  ...
  },
  {
    ...
    stock: 400,
    condition: 'used',
    images: ['/placeholders/rail-r50-used.svg'],
    categoryId: 'rails-used',
    sectionId: 'rails',
  ...
  // Части рельсов
  {
    ...
    stock: 1000,
    condition: 'service',
    images: ['/placeholders/rail-cut.svg'],
  ...
  // Шпалы деревянные
  {
    ...
    stock: 5000,
    condition: 'new',
    images: ['/placeholders/sleeper-wood.svg'],
  ...
  // Шпалы железобетонные
  {
    ...
    stock: 2000,
    condition: 'new',
    images: ['/placeholders/sleeper-concrete.svg'],
  ...
  // Башмаки тормозные
  {
    ...
    stock: 5000,
    condition: 'new',
    images: ['/placeholders/shoe-brake.svg'],
  ...
  // Башмаки подкладочные
  {
    ...
    stock: 40000,
    condition: 'new',
    images: ['/placeholders/shoe-pad.svg'],
  ...
  // Упоры бетонные
  {
    ...
    stock: 100,
    condition: 'new',
    images: ['/placeholders/buffer-concrete.svg'],
  ...
  // Упоры металлические
  {
    ...
    stock: 50,
    condition: 'new',
    images: ['/placeholders/buffer-metal.svg'],
  ...
  // Ручной инструмент
  {
    ...
    stock: 200,
    condition: 'new',
    images: ['/placeholders/tool-hammer.svg'],
  ...
  },
  {
    ...
    stock: 150,
    condition: 'new',
    images: ['/placeholders/tool-wrench.svg'],
    categoryId: 'tools-manual',
    sectionId: 'tools',
  ...
  // Механизированный инструмент
  {
    ...
    stock: 20,
    condition: 'new',
    images: ['/placeholders/tool-drill.svg'],
  ...
  },
  {
    ...
    stock: 30,
    condition: 'new',
    images: ['/placeholders/tool-grinder.svg'],
    categoryId: 'tools-mechanized',
    sectionId: 'tools',
